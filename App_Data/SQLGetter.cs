...
namespace DashboardApplication
{
    public class SQLGetter
    {
        ...
        {
            var table = new DataTable();
            String query = "select AssignmentID, CollectionID, CollectionName, SoftwareName, NumberErrors, NumberSuccess, NumberUnknown, SummarizationTime from v_DeploymentSummary order by NumberErrors DESC";
            ...
            String query2 = "select AssignmentID, TargetCollectionID, Descript, ModificationTime, Error, Success, Unknown, RequirementsNotMet from v_AppDeploymentSummary order by Error DESC";
        ...
        */
        public static string GetDashData()
        {
            ...
            System.Diagnostics.Debug.WriteLine(activeJSONresult);
            System.Diagnostics.Debug.WriteLine("activeJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine(threatJSONresult);
            System.Diagnostics.Debug.WriteLine("threatJsonResult");
           ...
           // System.Diagnostics.Debug.WriteLine(activeJSONresult);
            System.Diagnostics.Debug.WriteLine("uncompliantJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("healthJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("passfailJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("prodJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("detectJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("rebootJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("rebootSevenJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("reboot14JsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("rebootMonthJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("rebootTMonthJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("rebootSMonthJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("reboot12JsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("activepassJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("inactivepassJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("inactiveUnknownJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("activeUnknpwnsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("activeFAIlJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("inactiveFailJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("unhealthuJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("agentJsonResult");
            ...
            System.Diagnostics.Debug.WriteLine("threatString");
            ...
            System.Diagnostics.Debug.WriteLine("detectiongString");
            ...
            //System.Diagnostics.Debug.WriteLine(rebootSeven);
            //System.Diagnostics.Debug.WriteLine(rebootJSONresult);
